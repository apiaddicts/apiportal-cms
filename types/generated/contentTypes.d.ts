...
export interface ApiApimConfigApimConfig extends Struct.CollectionTypeSchema {
  collectionName: 'apim_configs';
  info: {
    description: '';
    displayName: 'ApimConfig';
    pluralName: 'apim-configs';
    singularName: 'apim-config';
  };
  options: {
...
export interface ApiBlogItemBlogItem extends Struct.CollectionTypeSchema {
...
export interface ApiLibraryApiLibraryApi extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    status: Schema.Attribute.Enumeration<['publicado', 'noPublicado']>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    library_apis: Schema.Attribute.Relation<
      ...
      'api::library-api.library-api'
    >;
    limitSubscription: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
