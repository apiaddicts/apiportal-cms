...
export interface ApiLibraryApiLibraryApi extends Schema.CollectionType {
  ...
  info: {
    description: '';
    displayName: 'LibraryApi';
    name: 'LibraryApi';
    pluralName: 'library-apis';
    singularName: 'library-api';
  };
  options: {
    draftAndPublish: true;
    increments: true;
  ...
  attributes: {
    benefits: Attribute.Component<'home.work-section', true>;
    buttons: Attribute.Component<'links.button', true>;
    color_status: Attribute.String;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
    ...
    publishedAt: Attribute.DateTime;
    slug: Attribute.UID;
    status: Attribute.Enumeration<['publicado', 'noPublicado']>;
    tags: Attribute.Component<'elements.titles', true>;
    title: Attribute.String;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    contentSections: Attribute.DynamicZone<
      [
        'sections.button-hero',
        'elements.entry',
        'sections.time-section',
        'sections.calculate-section',
        'sections.our-products-section',
        'sections.for-all-section',
        'sections.title-section',
        'sections.questions-list-section',
        'sections.section-use-case',
        'use-cases.calculate-use-case',
        'sections.section-widget-form',
    ...
    createdBy: Attribute.Relation<'api::page.page', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    metadata: Attribute.Component<'meta.metadata'> & Attribute.Required;
    shortName: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::page.page', 'shortName'> & Attribute.Required;
    updatedAt: Attribute.DateTime;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    accentColor: Attribute.Enumeration<['primary', 'secondary', 'tertiary']>;
    ...
    > &
      Attribute.Private;
    description: Attribute.Text;
    formSetting: Attribute.JSON;
    legalConditionals: Attribute.RichText;
    library_apis: Attribute.Relation<
      'api::product.product',
      'manyToMany',
      'api::library-api.library-api'
    >;
    limitSubscription: Attribute.Integer;
    price: Attribute.Integer;
    publishedAt: Attribute.DateTime;
    requiredApproval: Attribute.Boolean;
    requiredSubscription: Attribute.Boolean;
